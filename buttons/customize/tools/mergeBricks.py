...
class mergeBricks(Operator):
    ...
    def mergeBricks(bricksDict, keys, cm, mergeVertical=True, targetType="BRICK", height3Only=False):
        ...
        for key in keys:
            ...
            brickSize = attemptMerge(bricksDict, key, keys, bricksDict[key]["size"], zStep, randState, brickType, maxWidth, maxDepth, legalBricksOnly, mergeInconsistentMats, mergeShellWithInternal, materialType, preferLargest=True, mergeVertical=mergeVertical, targetType=targetType, height3Only=height3Only)
