...
bpy.ops.bricker.brickify_anim_in_background(frame=frame or -1)
target_obj = bpy.data.objects.get("Bricker_" + cm.source_obj.name + "_bricks_f_" + str(frame))
...
data_blocks = [target_obj, parent_obj]
